...
<main class="mainBody">
                    ...
                    <div class="row">
                            ...
                            <a href="#">
                                <div class="category_content text-center">
                                    <div class="category_img">
                                        <img src="{{asset('frontEndAsset')}}/assets/images/categories/5aefd05f226f4_image.webp" alt="" srcset="" />
                                    </div>
                        ...
                        <div class="col-md-2 pb-4">
                            <a href="#">
                                <div class="category_content text-center">
                                    <div class="category_img">
                                        <img src="{{asset('frontEndAsset')}}/assets/images/categories/0abca295badd4_image.webp" alt="" srcset="" />
                                    </div>
                                    <div class="category_text text-center pb-2">
                                        <h5>উপন্যাস</h5>
                                        <h6>Up to 25% OFF</h6>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-2 pb-4">
                            <a href="#">
                                <div class="category_content text-center">
                                    <div class="category_img">
                                        <img src="{{asset('frontEndAsset')}}/assets/images/categories/fbc52375a1c64_image.webp" alt="" srcset="" />
                                    </div>
                                    <div class="category_text text-center pb-2">
                                        <h5>ভর্তি, নিয়োগ ও প্রস্তুতি</h5>
                                        <h6>Up to 25% OFF</h6>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-2 pb-4">
                            <a href="#">
                                <div class="category_content text-center">
                                    <div class="category_img">
                                        <img src="{{asset('frontEndAsset')}}/assets/images/categories/d9c6ae76c2a34_image.webp" alt="" srcset="" />
                                    </div>
                                    <div class="category_text text-center pb-2">
                                        <h5>মুক্তিযুদ্ধ</h5>
                                        <h6>Up to 25% OFF</h6>
                        ...
                        <div class="col-md-2 pb-4">
                            <a href="#">
                                <div class="category_content text-center">
                                    <div class="category_img">
                                        <img src="{{asset('frontEndAsset')}}/assets/images/categories/93cad604849c4_image.webp" alt="" srcset="" />
                                    </div>
                                    <div class="category_text text-center pb-2">
                                        <h5>বিনিয়োগ ও অর্থনীতি</h5>
                                        <h6>Up to 25% OFF</h6>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col_5_change mb-2">
                            <div class="hotDis_col f_border text-center">
                                <div class="hotDis_img">
                                    <img src="{{asset('frontEndAsset')}}/assets/images/discount_product/1.jpg" alt="" srcset="" />
                                </div>
                        ...
                        <div class="col_5_change mb-2">
                            <div class="hotDis_col f_border text-center">
                                <div class="hotDis_img">
                                    <img src="{{asset('frontEndAsset')}}/assets/images/discount_product/2.jpg" alt="" srcset="" />
                                </div>
                                <div class="hotDiscount_content">
                        ...
                        <div class="col_5_change mb-2">
                            <div class="hotDis_col f_border text-center">
                                <div class="hotDis_img">
                                    <img src="{{asset('frontEndAsset')}}/assets/images/discount_product/5.jpg" alt="" srcset="" />
                                </div>
                                <div class="hotDiscount_content">
                        ...
                        <div class="col_5_change mb-2">
                            <div class="hotDis_col f_border text-center">
                                <div class="hotDis_img">
                                    <img src="{{asset('frontEndAsset')}}/assets/images/discount_product/3.jpg" alt="" srcset="" />
                                </div>
                                <div class="hotDiscount_content">
                        ...
                        <div class="col_5_change mb-2">
                            <div class="hotDis_col f_border text-center">
                                <div class="hotDis_img">
                                    <img src="{{asset('frontEndAsset')}}/assets/images/discount_product/4.jpg" alt="" srcset="" />
                                </div>
                                <div class="hotDiscount_content">
        ...
        <section id="All_product"
            ...
            <div class="mb-5 mt-5">
                <div class="container">
                    <div class="row">
                        <h3 class="title_text_blue pt-4 pb-4">শিশুদের <span class="title_text_orange">ইসলামিক বই </span> </h3>
                        <div class="col_5_change mb-2">
                            <div class="product_col f_border text-center">
                                <div class="product_img">
                                    <img src="{{asset('frontEndAsset')}}/assets/images/all-product/1.jpg" alt="" srcset="" />
        ...
        <section id="Feature_product" class="background-res background-ats py-3 d-flex justify-content-center align-items-center"
        style="background-image: url('{{asset('frontEndAsset')}}/assets/images/background_img/Background-Image-1.png');">
          <div class="container">
            <div class="row">
        ...
        <section id="Kasmeri_Shal" class="background-res background-ats py-3 d-flex justify-content-center align-items-center"
        style="background-image: url('{{asset('frontEndAsset')}}/assets/images/background_img/Background-Image-1.png');">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                <div class="kasmeri_col f_border text-center">
                  <div class="kasmeri_img">
                    <img src="{{asset('frontEndAsset')}}/assets/images/kasmeri-shal/embroided-kashmiri-shawl-500x500-500x500.jpg" alt="" srcset="" />
                  </div>
              ...
              <div class="col-md-3 mb-3">
                <div class="kasmeri_col f_border text-center">
                  <div class="kasmeri_img">
                    <img src="{{asset('frontEndAsset')}}/assets/images/kasmeri-shal/18c2614b3df84932ba9bda33d33e3121.jpg" alt="" srcset="" />
                  </div>
        ...
        <section id="Our_talk"
            class="background-res background-ats pt-3 d-flex justify-content-center align-items-center"
            style="background-image: url('{{asset('frontEndAsset')}}/assets/images/background_img/Background-Image-1.png');">
            <div class="">
                <div class="aboutUs">
                    <div class="container">
            ...
            <div class="">
                <div class="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="title_text_blue pt-4 pb-4">আমাদের <span
                                        class="title_text_orange">সম্পর্কে</span> </h3>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="custSupport d-flex ">
                                                            <p class="custIcon"><i class="fas fa-cloud-download-alt"></i></p>
